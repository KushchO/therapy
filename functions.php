...
if ( ! function_exists( 'maximus_setup' ) ) :
	...
	function maximus_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'maximus_custom_background_args', array(
...
function maximus_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'maximus' ),
...
function maximus_scripts() {
	wp_enqueue_style( 'maximus-style', get_stylesheet_uri() );

	wp_enqueue_script( 'maximus-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

  wp_enqueue_script( 'maximus-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

  wp_enqueue_script( 'jQuery', get_template_directory_uri() . '/js/jquery.min.js', array(), '20151215', true );

  wp_enqueue_script( 'beforAfter', get_template_directory_uri() . '/js/before-after.js', array(), '20151215', true );
